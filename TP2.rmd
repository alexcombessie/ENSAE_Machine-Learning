...
<<<<<<< HEAD:TP2.rmd
\newpage
Les 8 variables les plus "pertinentes" sont donc les 8 premi�res en haut du graphique, soit: 
=======

Les 8 variables les plus "pertinentes" sont donc les 8 premières en haut du graphique, soit: 
>>>>>>> origin/master:TP2_v1.2.Rmd
...
<<<<<<< HEAD:TP2.rmd
En comparant la matrice de confusion obtenue � la question 4 et la matrice de confusion ci-dessous, on remarque que l'erreur de prediction pour l'arbre de decision est inferieure � l'erreur de prediction pour l'algorithme knn, on en conclut que l'algorithme d'arbre de decision est meilleur que knn au sens de l'erreur de classification sur notre �chantillon. 
